...
This project is a simple and responsive calculator built using React.  
It is designed as a practice project to learn React fundamentals such as components, state management, and event handling.
